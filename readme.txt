...
The plugin allows customization and storage of css files in a separate folder for the OrderStorm eCommerce plugin to prevent changes from being lost in an update.
